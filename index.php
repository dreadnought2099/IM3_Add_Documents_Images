...
<head>
    ...
    <link rel="icon" href="icon/people.png">
</head>

<body class="bg-gray-100">

    <div class="container mx-auto p-8">
        <h1 class="text-2xl font-bold text-center mb-6 text-purple-500">Add a New Guest</h1>
        ...
        <form method="post" action="" enctype="multipart/form-data" class="max-w-md mx-auto bg-white p-6 rounded-lg shadow-lg">
            ...
            <input type="text" name="first_name" required class="w-full p-2 border focus:border-purple-500 focus:ring-purple-500 rounded-md mb-4">
            ...
            <button type="submit" name="add" class="w-full bg-purple-500 text-white py-2 rounded-md hover:bg-white hover:text-purple-500 border border-2 hover:border-purple-500 transition">
                Add Guest
            </button>
        </form>

        <h2 class="text-xl font-semibold text-center mt-8 text-purple-500">Guest Table View</h2>
                    ...
                    if ($result->num_rows > 0) {
                        while ($row = $result->fetch_assoc()) {
                            ...
                            echo "</td>
                                ...
                                <td class='p-3 text-center'>
                                    <a href='edit.php?edit_id={$row['id']}' class='bg-purple-500 text-white px-3 py-1 rounded-md hover:bg-white hover:text-purple-500 border border-1 hover:border-purple-500 transition'>Edit</a>
                                    <a href='delete.php?delete_id={$row['id']}' class='bg-red-500 text-white px-3 py-1 rounded-md hover:bg-white hover:text-red-500 border border-1 hover:border-red-500 transition' onclick='return confirm(\"Are you sure you want to delete?\")'>Delete</a>
                                </td>
                              </tr>";
                        }
                    } else {
