...
<body class="bg-gray-100">
    <div class="container mx-auto p-8">
        <h1 class="text-2xl font-bold text-center mb-6 text-purple-500">Edit Guest</h1>
        ...
        <form method="post" action="edit.php" enctype="multipart/form-data" class="max-w-md mx-auto bg-white p-6 rounded-lg shadow-lg">
            ...
            <button type="submit" class="w-full bg-purple-500 text-white py-2 rounded-md hover:bg-purple-500 hover:bg-white hover:text-purple-500 border border-2 hover:border-purple-500 transition">
                Update Guest
            </button>
        </form>
    </div>
